...
export default class MulticationParam extends React.Component {
  ...
  GoToNextScreen() {
    if (this.state.lowNoToPer == '') {
      ...
      this.refs.toast.show('Enter lowest no. to Percentage', 2000);
    } else if (this.state.highNoToPer == '') {
      this.refs.toast.show('Enter highest no. to Percentage', 2000);

    } else if (this.state.lowNoPerBy == '') {
      this.refs.toast.show('Enter Lowest no. to Percentage by ', 2000);

    } else if (this.state.highNoPerBy == '') {
      this.refs.toast.show('Enter Highest no. to Percentage by ', 2000);
